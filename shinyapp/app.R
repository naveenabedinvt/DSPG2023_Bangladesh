...
"), 
  ...
  tabPanel("Conclusion", value = "overview",
           fluidRow(style = "margin: 6px;",
                    p("", style = "padding-top:10px;"),
                    column(12, align = "Center",h1(strong("Conclusion")), br("")),
                    column(6, align = "justify",
                           
                           p("In this study, we examined the association of flood exposure on child health outcomes in Bangladesh. By combining BIHS data with GFD and CHIRPS data, we unveiled the extent of household flood exposure and its correlation on child health outcomes. Our findings indicate that if a mother is exposed to flooding during her third trimester during pregnancy, her child is more likely to be stunted. These results align with several other studies, including (Del Ninno, et al., 2005), which reached similar conclusions. However, the association between prenatal flood exposure and underweight prevalence among children was somewhat ambiguous. This weak association was attributed to many other confounding factors, such as the mother's educational attainment and the household's economic status, which can also influence child health outcomes."),
                           p("The second part of our study was to investigate the mechanisms through which floods affect child health outcomes. We identified three primary mechanisms: access to healthcare facilities, consumption patterns and nutrition, and water quality and consumption, consumption patterns and nutrition. First, since most of the population relies on tube wells and open water sources for drinking water, pregnant mothers and children are exposed to waterborne diseases during and after flood events as treating water is not a common practice in Bangladesh. Second, floods disrupt mothers' consumption patterns and nutrition as our results showed a decline in the percentage of mothers taking critical nutritional supplements like vitamin A, Iron, and Calcium among households facing high-intensity rainfall. Third, access to healthcare facilities and services is another defining factor in child health outcomes."),
                    ),
                    column(6, align = "justify",
                           
                           p("In Bangladesh, rural households lack access to healthcare services due to the absence of medical infrastructures and proper roads, making it difficult for them to reach hospitals. Some individuals may have to travel up to 12 km to access the nearest medical facility which poses significant barriers to timely and adequate healthcare. Lastly, other mechanisms through which floods affect child health outcomes include agricultural and industrial disruptions, displacement, and substandard living conditions. For example, 69% of Aus rice production, 82% of deep water Aman and 91% of transplanted Aman were destroyed in the 1998 Bangladesh flood, leaving the whole country food insecure (Del Ninno, et al., 2001). Flood related displacement can also lead to unexpected child health outcomes. The Bangladesh Flood Plan Coordination Organization (1995) estimated that river swellings displaced over 728,000 people between 1981 and 1993 along the Jamuna, Granges-Padma and Meghna rivers."),
                           p("Flood exposure and its associations on child health outcomes are real problems that require initiatives to improve drinking water quality and access to healthcare services during and after flood events. Short-term initiatives can include promoting water treatment practices, such as boiling or filtration, and raising community awareness about the importance of maternal healthcare. Long-term plans involve investing in medical infrastructure and services and improving road connectivity in rural areas, significantly enhancing access to healthcare services. This will facilitate timely medical interventions and improve child health outcomes during floods. Finally, as an ongoing project, we hope to extend our analysis to explore the other mechanisms like agricultural disruptions, displacement, and substandard living conditions."),
  ...
  tabPanel("References", value = "overview",
           fluidRow(style = "margin: 6px;",
                    ...
                    column(6, align = "justify",
                           ...
                           p("Aggarwal, S. (2021). The long road to health: Healthcare utilization impacts of a road pavement policy in rural India. Journal of Development Economics, 151, 102667."),
                           ...
                           p("Bairagi, S., Bhandari, H., Das, S. K., & Mohanty, S. (2018). Impact of Submergence-Tolerant Rice Varieties on Smallholders' Income and Expenditure: Farm-Level Evidence from Bangladesh. Selected Paper prepared for presentation at the 2018 Agricultural & Applied Economics Association Annual Meeting, Washington, D.C., August 5-7."),
                    ...
                    column(6, align = "justify",
                           ...
                           p("River and drainage system. Banglapedia. (n.d.). https://en.banglapedia.org/index.php/River_and_Drainage_System"),
                           ...
                           p("Smiley, S. L., Hambati, H. (2019). Impacts of flooding on drinking water access in Dar es Salaam, Tanzania: implications for the Sustainable Development Goals. Journal of Water, Sanitation and Hygiene for Development, 9(2), 392–396. https://doi.org/10.2166/washdev.2019.168"),
                           ...
                           p("U.S. Census Bureau Current Population. Current Population. (n.d.). https://www.census.gov/popclock/print.php?component=counter"),
                           ...
                           p("Wai, K. M., Mar, O., Kosaka, S., Umemura, M., & Watanabe, C. (2017). Prenatal heavy metal exposure and adverse birth outcomes in Myanmar: A birth-cohort study. International Journal of Environmental Research and Public Health, 14(11). https://doi.org/10.3390/ijerph14111339"),
